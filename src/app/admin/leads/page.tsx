...
function LeadDrawer({ leadId, onClose, onUpdated }: {
  ...
  const buildWaMessage = (l: LeadFull) => {
    ...
    const footer = '\n\nM\u00e1s info: https://sofia.redsolucionesti.com'
      + '\nPru\u00e9balo: https://wa.me/51977588512'
      + '\n\nSi te interesa coordinamos una demo r\u00e1pida de 10-15 min.';
    if (emailSent) {
      return 'Hola, te escribo por aqu\u00ed tambi\u00e9n (intentamos contactarte por correo) para presentarte SofIA, asistente de WhatsApp con IA para cl\u00ednicas dentales:\n\n' + FEATURES + footer;
    }
    return 'Hola, soy Gabriel de RedSoluciones TI. Me pongo en contacto porque ' + l.nombre + ' tiene una gran presencia y quer\u00eda presentarles SofIA, asistente de WhatsApp con IA para cl\u00ednicas dentales:\n\n' + FEATURES + footer;
  };
